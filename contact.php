...
if(isset($_POST['name']))
{
	...
	$to = "losconsentidoschile@gmail.com";
	$subject = "Los consentidos";
	$message = " Name: " . $name ."\r\n Email: " . $email . "\r\n Message:\r\n" . $message;
	...
	{
	  $text = "<span style='color:blue; font-size: 35px; line-height: 40px; margin: 10px;'>Tu mensaje se envió correctamente !</span>";
	}
}
?>
<!DOCTYPE html>
...
<head>
	...
	<title>Los Con-Sentidos Resto-Bar</title>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					<li>
                        <a class="page-scroll" href="index.html#intro">Inicio</a>
                    </li>
					<li>
			    ...
			    <div class="item active">
                    ...
                    <div class="header-text hidden-xs">
                        <div class="col-md-12 text-center">
                            <h2>Bienvenidos a Los Con-Sentidos Resto-Bar</h2>
                            <br>
                            <h3>Estamos trabajando para poder atenderles, lo mas pronto posible.</h3>
                            <br>
                            <div class="">
